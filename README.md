...
T3 Code is a minimal web GUI for coding agents (currently Codex, Claude, Cursor, Grok, Muse Code, Prime Agent, and OpenCode, with more coming soon).

## Installation

> [!WARNING]
> T3 Code currently supports Codex, Claude, Cursor, Grok, Muse Code, Prime Agent, and OpenCode.
...
- Provider guides: [Codex](./docs/providers/codex.md), [Claude](./docs/providers/claude.md), [Muse Code](./docs/providers/muse.md), and [Prime Agent](./docs/providers/prime-agent.md)
