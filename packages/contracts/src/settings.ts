...
export const MuseSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("muse").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Muse Code binary used by this instance.",
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional CLI arguments passed to muse exec on each turn.",
...
export const PrimeSettings = makeProviderSettingsSchema(
  {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional CLI arguments passed when starting Prime Agent ACP sessions.",
        providerSettingsForm: { clearWhenEmpty: "omit" },
      }),
    ),
    customModels: Schema.Array(Schema.String).pipe(
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let the app spawn the server when needed.",
        providerSettingsForm: {
