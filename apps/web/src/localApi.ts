...
function createBrowserLocalApi(): LocalApi {
  return {
    ...
    server: {
      ...
      startAuthConnector: () => Promise.reject(unavailableLocalBackendError()),
      getAuthConnector: () => Promise.reject(unavailableLocalBackendError()),
      submitAuthConnector: () => Promise.reject(unavailableLocalBackendError()),
      cancelAuthConnector: () => Promise.reject(unavailableLocalBackendError()),
