    ...
    return (
      <>
        ...
        {desktopWslState.enabled ? (
          <SettingsRow
            title="WSL only"
            description={`Stop the Windows backend and run only the WSL backend. Useful if you develop entirely inside WSL and don't want a second backend process. ${APP_BASE_NAME} restarts when you change this.`}
