...
/**
 * Non-image attachments have no preview to render; the transcript shows a chip
 * carrying the name and size instead, so the optional `previewUrl` that images
 * use is deliberately absent here.
 */
