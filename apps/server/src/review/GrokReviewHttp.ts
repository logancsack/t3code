...
export const ALDO_REVIEW_HTTP_PATH = "/api/review/aldo";
...
const handleAldoReview = Effect.gen(function* () {
...
export const grokReviewHttpRouteLayer = Layer.merge(
  HttpRouter.add("POST", GROK_REVIEW_HTTP_PATH, handleAldoReview),
  HttpRouter.add("POST", ALDO_REVIEW_HTTP_PATH, handleAldoReview),
);
