 ...
 *
 *   - orchestration events, receipts, projections, and provider session
 *     runtime rows, paged by rowid so memory stays bounded (standalone
 *     `checkpoint_diff_blobs` is never written and has no hub table);
