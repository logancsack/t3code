...
import * as TurnLivenessWatchdog from "../src/orchestration/Services/TurnLivenessWatchdog.ts";
...
const startupDependencies = Layer.mergeAll(
  ...
  Layer.succeed(TurnLivenessWatchdog.TurnLivenessWatchdog, { start: () => Effect.void }),
